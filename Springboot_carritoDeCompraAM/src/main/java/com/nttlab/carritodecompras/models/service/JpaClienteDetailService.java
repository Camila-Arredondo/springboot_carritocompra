...
@Service("JpaClienteDetailService")
public class JpaClienteDetailService implements UserDetailsService{
	
	@Autowired
	private iClienteDAO clienteDao;

	private Logger logger = LoggerFactory.getLogger(JpaClienteDetailService.class);
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		return new User(cliente.getEmail(), cliente.getPassword(), cliente.isActive(), true, true, true,
				authorities);
	}
